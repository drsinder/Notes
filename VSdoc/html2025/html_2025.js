...
function initTocHamburger() {
    var tocHamburger = document.getElementById("toc-hamburger");
    if (!tocHamburger) {
        return;
    }
    var tocArea = document.getElementById("toc-area");
    if (!tocArea) {
        return;
    }
    var tocAreaOverlay = document.getElementById("toc-area-overlay");
    if (!tocAreaOverlay) {
        return;
    }
    ...
    // hamburger click toggles the TOC.
    registerEventHandler(tocHamburger, "click", function () {
        tocArea.classList.toggle('toc-open');
        tocAreaOverlay.classList.toggle('toc-open');
        mainBody.classList.toggle('toc-open');
    });

    // A click in the overlay closes the TOC.
    registerEventHandler(tocAreaOverlay, "click", function () {
        tocArea.classList.toggle('toc-open');
        tocAreaOverlay.classList.toggle('toc-open');
        mainBody.classList.toggle('toc-open');
    });
